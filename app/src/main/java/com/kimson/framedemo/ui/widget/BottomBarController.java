...
/**
 * Created by zhujianheng on 6/15/16.
 */
public class BottomBarController {
    ...
    private static final String EXTRA_TAG_COUNT = BottomBarController.class.getName() + ":EXTRA_TAG_COUNT";
    private static final String EXTRA_SELECTED_TAB_INDEX = BottomBarController.class.getName() + ":EXTRA_SELECTED_TAB_INDEX";
    private static final String EXTRA_CURRENT_FRAGMENT = BottomBarController.class.getName() + ":EXTRA_CURRENT_FRAGMENT";
    private static final String EXTRA_FRAGMENT_STACK = BottomBarController.class.getName() + ":EXTRA_FRAGMENT_STACK";
    ...
    public BottomBarController(Bundle savedInstanceState, @NonNull FragmentManager fragmentManager, @IdRes int containerId, @NonNull List<Fragment> baseFragments) {
    ...
    public BottomBarController(Bundle savedInstanceState, @NonNull FragmentManager fragmentManager, @IdRes int containerId, @NonNull List<Fragment> baseFragments, @Transit int transitionMode){
